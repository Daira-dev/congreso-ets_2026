...
-- ESPECIFICACIONES TÃƒâ€°CNICAS Y SCRIPTS DDL (POSTGRESQL 15+ / 16+)
-- NORMALIZACIÃƒâ€œN ESTRICTA EN TERCERA FORMA NORMAL (3FN)
-- ============================================================================

CREATE EXTENSION IF NOT EXISTS "pgcrypto";

-- ----------------------------------------------------------------------------
-- 1. TABLAS DE CATÃƒÂLOGOS Y DOMINIO MAESTRO (1FN, 2FN, 3FN)
-- ----------------------------------------------------------------------------

-- CatÃƒÂ¡logo de Roles de Usuarios
...
-- CatÃƒÂ¡logo de Estados de InscripciÃƒÂ³n
...
-- CatÃƒÂ¡logo de Puntos de Acceso FÃƒÂ­sicos (NormalizaciÃƒÂ³n de ubicaciones en 3FN)
...
-- CatÃƒÂ¡logo de Tipos de AcreditaciÃƒÂ³n (NormalizaciÃƒÂ³n en 3FN)
...
-- CatÃƒÂ¡logo de Eventos Institucionales / Ediciones Anuales en el Tiempo
...
-- CatÃƒÂ¡logo de Actividades / Talleres / Aulas (NormalizaciÃƒÂ³n de aforos especÃƒÂ­ficos)
...
-- CatÃƒÂ¡logo de Operadores de AcreditaciÃƒÂ³n
...
-- RelaciÃƒÂ³n N:N para AsignaciÃƒÂ³n de Roles Adicionales
...
-- ----------------------------------------------------------------------------
-- 3. VALIDACIÃƒâ€œN DOCUMENTAL DE EXPOSITORES (HOMOLOGACIÃƒâ€œN DE PERGAMINOS)
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 5. RECONFIRMACIÃƒâ€œN INTERACTIVA (48 HORAS) Y TOKENS TEMPORALES
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 7. CERTIFICADOS OFICIALES Y VALIDACIÃƒâ€œN CRIPTOGRÃƒÂFICA
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 8. MÃƒâ€œDULO DE ENCUESTAS DINÃƒÂMICAS Y TEMARIOS (3FN)
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 9. CONFIGURACIÃƒâ€œN DEL SISTEMA, PUSH Y LOGS DE AUDITORÃƒÂA
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 10. ÃƒÂNDICES DE RENDIMIENTO Y CONSTRAINTS COMPUESTOS
-- ----------------------------------------------------------------------------
...
-- ÃƒÂndice optimizado para auditorÃƒÂ­a y consulta rÃƒÂ¡pida de ÃƒÂºltimo movimiento
...
-- ----------------------------------------------------------------------------
-- 11. FUNCIÃƒâ€œN TRANSACCIONAL CON BLOQUEO PESIMISTA Y GESTIÃƒâ€œN MULTI-EVENTO (3FN)
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 12. TRIGGER DE INTERCEPCIÃƒâ€œN PARA BLACKLIST (CON RESPETO A SUPERADMIN OVERRIDE)
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 13. PRIVILEGIOS DE APLICACIÃƒâ€œN
-- ----------------------------------------------------------------------------
